    ...
    const reports = [
        {
            ...
            content:"Sudah dua hari air PDAM di rumah saya tidak mengalir. Mohon tindak lanjut agar kebutuhan air bersih warga terpenuhi.",
        ...
        },
        {
            ...
            content: "Lampu penerangan jalan di Ringroad Utara sudah mati selama seminggu, sehingga jalan menjadi gelap dan rawan kecelakaan.",
        ...
        },
        {
            ...
            content:"Saya merasa pelayanan di bagian pendaftaran RS kurang ramah dan lambat. Mohon perbaikan agar pasien merasa nyaman.",
        ...
        },
        {
            ...
            content:"TPS di daerah saya sudah penuh dan belum diangkut selama 4 hari. Bau tidak sedap mulai mengganggu warga sekitar.",
        ...
        },
        {
            ...
            content:"Jalan di depan SDN 2 Maguwoharjo berlubang dan membahayakan anak-anak yang berangkat sekolah. Mohon segera diperbaiki.",
            ...
            <div className="min-w-[80%] w-full max-w-[1334px] mx-auto">
                ...
                <div className="bg-white rounded-lg p-6 mb-6">
                    {reports.map((report, index) => (
                        <div
                            key={report.id}
                            className={`${index !== reports.length - 1
                            ...
                            <div className="flex justify-between items-start mb-3">
                                <div className="flex items-center">
                                    <div className="w-10 h-10 bg-gray-300 rounded-full mr-3 flex items-center justify-center overflow-hidden">
                                        ...
                                        <User
                                            className={`user-icon w-5 h-5 text-gray-500 ${report.avatar ? "hidden" : "block"
                                                }`}
                                        />
                                    </div>
                                    <div>
